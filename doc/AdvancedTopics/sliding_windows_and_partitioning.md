...
stage). They are written as `VARCHAR` because their types are not known yet. After the first refresh, the persisted
schema is replaced with the types of the materialized Parquet.
