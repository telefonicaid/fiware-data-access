...
export const config = {
  ...
  postgre_client: {
    user: envVars.POSTGRE_CLIENT_USER,
    password: envVars.POSTGRE_CLIENT_PASSWORD,
    host: envVars.POSTGRE_CLIENT_HOST,
    port: envVars.POSTGRE_CLIENT_PORT,
  },
};
